...
public class projectileAlexis : MonoBehaviour
{
    ...
    public void deploy() 
    {
        if(knives > 0)
        {
            ...
            obj.GetComponent<projectileAlexis>().makeRotation();
            obj.GetComponent<projectileAlexis>().fired = true;
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            GameObject.Find("knife").GetComponent<projectileAlexis>().addKnife();
            Destroy(gameObject);
        }
    }
