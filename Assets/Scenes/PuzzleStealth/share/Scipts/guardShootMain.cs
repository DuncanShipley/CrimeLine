...
public class GuardShootMain : MonoBehaviour
{
    GameObject copy;
    float throwPause = 0;
    public int id;
    ...
    void Start()
    {
        waitTime = transform.parent.GetComponent<GuardVariablesMain>().GetShootWait();
    }
    ...
    void Update()
    {
        ...
        if (guardChaseMain.sus[id] == 1 && throwPause > waitTime)
        {
